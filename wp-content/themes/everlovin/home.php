	...
	<div id="main">
		<div class="container">
			<section class="featured-content">
				<?php $the_query = new WP_Query( array('post_type' => array('work'),'showposts' => '1' ));
				...
				<?php $the_query = new WP_Query( array('post_type' => array('work'),'showposts' => '1', 'offset' => '1' ));
		          while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
				...
				<?php $the_query = new WP_Query( array('post_type' => array('work'),'showposts' => '1', 'offset' => '2' ));
		          while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
		            <a class="largebox orange" href="<?php the_permalink(); ?>"><h2><?php the_title(); ?></h2></a>
		        <?php endwhile; wp_reset_postdata(); ?>
		       
		        <?php $the_query = new WP_Query( array('post_type' => array('work'),'showposts' => '1', 'offset' => '3' ));
		          while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
