                    ...
                    <tr id="slidedeck-lens-content-sources">
                        ...
                        <td>
    	                    <fieldset>
		                    	...
		                    	<?php foreach( $sources as $source => $source_model ): ?>
    		                        <label>
    			                        <input type="checkbox" value="<?php echo $source; ?>" name="data[sources][]"<?php if( in_array( $source, $lens['meta']['sources'] ) ) echo ' checked="checked"'; ?><?php if( $read_only ) echo ' disabled="disabled"'; ?> />
    			                        <?php echo $source_model['label']; ?>
    		                        </label>
		                        <?php endforeach; ?>
    	                    </fieldset>
                        </td>
