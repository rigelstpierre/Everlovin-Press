    ...
    function slidedeck_options_model( $options_model, $slidedeck ) {
        if( $this->is_valid( $slidedeck['lens'] ) ) {
            if( $slidedeck['type'] == "video" ) {
                $options_model['Interface']['show-author']['type'] = "hidden";
                $options_model['Interface']['show-author']['value'] = false;
                $options_model['Interface']['show-author-avatar']['type'] = "hidden";
                $options_model['Interface']['show-author-avatar']['type'] = false;
            }
            
            if( $slidedeck['source'] == "twitter" ) {
                $options_model['Content']['linkTitle']['type'] = "hidden";
                $options_model['Content']['linkTitle']['value'] = true;
