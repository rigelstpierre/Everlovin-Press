...
function onYouTubePlayerAPIReady() {
    jQuery('.source-type-videos .slidedeck').each(function(){
        ...
        deckElement.find('.video-container.youtube').each(function(){
            ...
            var videoID = videoContainerID.split('_')[1];
...
(function($){
    ...
    SlideDeckVideoAPIs = function( slidedeck ){
        var self = this;
        ...
        deckElement.find('.cover .play').click(function(event){
            ...
            var videoContainerID = cover.prev('.video-container').attr('id').split('_')[1];
            ...
            var videoIndex = slides.index( jQuery( '[id*="video_' + videoContainerID + '"]' ).closest('dd') );
        ...
        deckOptions.complete = function(deck){
            ...
            var playerType = deckContext.slides.eq(current - 1).find('.video-container')[0].className.split(' ')[0];
        ...
        function playVideoIfPaused( index, playerType ){
            ...
            switch( playerType ){
                ...
                case 'vimeo':
                    if( typeof( player ) != 'undefined' ){
                        // It seems that the API functions that return a falue need to do so via a
    ...
    $(document).ready(function(){
        ...
        $('.slidedeck').each(function(){
            ...
            $('.source-type-videos .slidedeck').each(function(){
