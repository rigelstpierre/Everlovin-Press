...
(function($){
        ...
        eventOnLoad: function(){
            ...
            if(this.elems.noContent.length){
                ...
                this.elems.noContent.find('.no-content-source-configuration').bind('click', function(event){
                    ...
                    $('#slidedeck-content-source').toggle();
                });
            }
    ...
    SlideDeckPreview.updates['options[titleFont]'] = SlideDeckPreview.updates['options[bodyFont]'] = function($elem, value){
        ...
        if($elem[0].name == "options[titleFont]"){
            SlideDeckPreview.elems.slidedeck.find('.slide-title').css('font-family', font.stack);
            if(font.weight) SlideDeckPreview.elems.slidedeck.find('.slide-title').css('font-weight', font.weight);
    ...
    SlideDeckPreview.updates['options[speed]'] = function($elem, value){
        ...
        if(SlideDeckPreview.slidedeck.verticalSlides){
            if(SlideDeckPreview.slidedeck.verticalSlides[0]){
                if(SlideDeckPreview.slidedeck.verticalSlides[0].slides){
                    SlideDeckPreview.slidedeck.verticalSlides[0].options.speed = value;
                }
            }
        }
    };
